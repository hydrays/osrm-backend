#ifndef TRAFFIC_PREDICTION
#define TRAFFIC_PREDICTION
...
namespace engine
{
namespace traffic_prediction
{

using namespace routing_algorithms;

template <class DataFacadeT>
class TrafficPrediction final
    : public BasicRoutingInterface<DataFacadeT, TrafficPrediction<DataFacadeT>>
{
    using super = BasicRoutingInterface<DataFacadeT, TrafficPrediction<DataFacadeT>>;
